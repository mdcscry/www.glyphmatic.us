...
function initOuterStyle(){
	...
	for (containerCounter=1;containerCounter<=containerCount;containerCounter++){
		...
		containerId[containerCounter].style.filter = 'saturate('+ Math.round(Math.random()*1000) +'%)';
	}
}
...
function initStyle(){
		...
		for (divCounter=1;divCounter<=totDivCounter;divCounter++){
			...
			// In initStyle function:
			divId[divCounter].style.transform = 'rotateX(' + Math.round(Math.random()*60-60) + 'deg) '
				+ 'rotateY(' + Math.round(Math.random()*60-60) + 'deg) '
				+ 'skew('+ Math.round(Math.random()*45-22.5) +'deg,'+ Math.round(Math.random()*60-30+180) +'deg)';
			divId[divCounter].style.filter = 'saturate('+ Math.round(Math.random()*3000) +'%)';
			...
			divId[divCounter].style.left=Math.random()*95-10+'%';
...
function changeSkewRotation(){
           ...
           //node.style.webkitTransform= 'skew('+ Math.round(Math.random()*180) +'deg,'+ Math.round(Math.random()*180) +'deg)';
			...
			node.style.transform = 'rotateX(' + Math.round(Math.random()*360-180) + 'deg) '
				+ 'rotateY(' + Math.round(Math.random()*180) + 'deg) '
				+ 'skew('+ Math.round(Math.random()*60-30) +'deg,'+ Math.round(Math.random()*360) +'deg)';
