...
function startFlavor0() {
    ...
    const chars = INSERT31_CHARS;
    let animationFrameId = null;
    let currentPalette = [];
    let colorOffset = 0;
    
    function randomPalette() {
        return INSERT31_PALETTES[Math.floor(Math.random() * INSERT31_PALETTES.length)];
    }
...
function startVisualization(flavor) {
    ...
    if (!document.getElementById('insert31-styles')) {
        ...
        style.textContent = INSERT31_CSS;
