...
// block_lang['CJK_Compatibility_Ideographs'] = ['chinese-simplified','noto-trad-chinese','noto-hongkong'];
 block_lang['CJK Radicals Supplement'] = ['noto-japanese'];
...
// block_lang['Kana Extended-B'] = ['kana-extended-b'];
 ...
 block_lang['Supplemental Symbols and Pictographs'] = ['emoji-bw','unicode-symbol-fonts','symbola','bw-emoji-extra'];
