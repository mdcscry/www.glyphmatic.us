...
myFontSet[31]=['x11A00;&#x11A06;&#x11A35','Noto Sans Zanabazar Square']; // Zanabazar Square Om
...
glyphDescriptions[2] = 'Latin Om (composite)';
glyphDescriptions[3] = 'Ik Onkar (Gurmukhi)';
glyphDescriptions[4] = 'Om symbol';
glyphDescriptions[5] = 'Tibetan Om';
glyphDescriptions[6] = 'Tamil Om';
glyphDescriptions[7] = 'Bengali Om (composite)';
glyphDescriptions[8] = 'Telugu Om (composite)';
glyphDescriptions[9] = 'Malayalam Om (composite)';
glyphDescriptions[10] = 'Gurmukhi Om (composite)';
glyphDescriptions[11] = 'Sharada Om';
glyphDescriptions[12] = 'Balinese Om';
glyphDescriptions[13] = 'Cham Om';
glyphDescriptions[14] = 'Cham Om v.2';
...
glyphDescriptions[33] = 'Khmer Sign Avakrahasanya';
glyphDescriptions[34] = 'Sundanese Om';
glyphDescriptions[35] = 'Thai Om';
glyphDescriptions[36] = 'Thai Character Khomut';
glyphDescriptions[37] = 'Chinese/Japanese Om (唵)';
glyphDescriptions[38] = 'Korean Om (옴)';
glyphDescriptions[39] = 'Japanese A-Un (阿吽)';
glyphDescriptions[40] = 'Japanese Om (Katakana オーム)';
glyphDescriptions[41] = 'Manchu Om (ᢀᠣ)';
glyphDescriptions[42] = 'Mongolian Om (ᢀᠣᠸᠠ)';
glyphDescriptions[43] = 'Thaana Om (އޮމް)';
